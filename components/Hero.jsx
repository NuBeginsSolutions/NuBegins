        ...
        <div className="grid">
          <div className="stagger-animation">
            ...
            <div className="icon-grid">
              {[
                { icon: <Code className="icon kudevs-blue" size={24} />, text: "Web Development",link:"/web-development" },
                { icon: <Paintbrush className="icon kudevs-purple" size={24} />, text: "Graphic Design",link:"/graphic-design" },
                { icon: <TrendingUp className="icon kudevs-teal" size={24} />, text: "Digital Marketing",link:"/digital-marketing" }
              ].map((item, index) => (
                <Link href={item?.link}>
